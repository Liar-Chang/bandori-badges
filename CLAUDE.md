...
├── badge-crop.html         # 徽章截圖/裁切工具(單張+批次+同框套用多圖,🔍 Hough 自動偵測,🗂 裁剪記錄資料集)
...
| 2026/06/01 | #3743–3817(Pastel 特別公演 3743–3748、Afterglow SP 3749–3758、Roselia Rausch 3759、エポスカード 3760、ちびキャラ 3761–3770、キラキラ 3771–3795、赤い羽根第2弾 3796–3799、Special☆LIVE GBP2020 記念缶バッジ 3800–3817) | 75 |
| 2026/06/02 | #3818–3862(3rd Season 放送記念 3818–3822、ブシロードEC トレーディング缶バッジ ホログラムver. 全30種 3823–3852、Morfonica Debut Event Prelude 3853–3862) | 45 |
| 2026/06/03 | #3863–3910(平成★GAL化計画 in ゲーマーズ〔5/28 已發 20,此 10 為新編號續批〕3863–3872、バンドリ！＆スタァライト展 in Gallery AaMo 3873–3879、8th☆LIVE 夏の野外3Days 3880–3900、Morfonica 1st Live「Cantabile」3901–3910) | 48 |
| 2026/06/04 | #3911–3937(ガルパ×赤い羽根共同募金コラボ第3弾 3911–3917、8th☆LIVE「Breakthrough!」〔個人+ホログラム〕3918–3927、Roselia×RAISE A SUILEN合同オンラインライブ「Rausch und/and Craziness -interlude-」3928–3937) | 27 |
| 2026/06/05 | #3938–3947(「BanG Dream! YUME∞MITA × animate cafe」in animate cafe STAND 3938–3942、Merry Closet ルームウェア&缶バッジセット Poppin'Party 3943–3947) | 10 |
| 2026/06/06 | #3978–4026(トレーディング缶バッジ キラキラver. vol.2〔全35種〕3978–4012、トレーディング缶バッジ 2020 Winter ver.〔7角×通常+ホロ〕4013–4026) | 49 |
| 2026/06/07 | #4027–4192(4周年記念ver. 4027–4061、ガルパ☆ピコ大盛り2021描き下ろし 4062–4068、Summer Vacation ver. 4069–4082、キラキラver. vol.3 4083–4117、赤い羽根共同募金コラボ第4弾 4118–4152、9th☆LIVE「The Beginning」4153–4172、9th☆LIVE「Mythology」4173–4192) | 166 |
| 2026/06/08 | #4193–4230(WEGOver. vol.4〔7角×通常+ホロ〕4193–4206、ビジュアルブック Vol.4＆5 ゲーマーズ限定版 4207–4216、Twinkle Party! ver.〔7角×通常+ホロ箔〕4217–4230) | 38 |

**目前最高已公告 ID = #4230(截至 2026/06/08;⚠️ #3948–3977 仍為跳號空缺、尚未公告)。** 下次新清單若出現 **≤ #4230** 的編號,先比對上表各範圍 —— **不在任一範圍內就是新增**(例如 #3948–3977 之後出現時屬新增、非重複);落在已公告範圍內才當重複嫌疑、逐一查證再排除。
...
🆕 **每次公告一次給齊兩塊(明羽 2026-06-02 起要求,不用再問「要不要出社群」)**:
- **(A) changelog.json 四語版** — 下面這個版型。
- **(B) 社群成品** — Threads(繁中)+ 𝕏 日/韓,**實際跑 announcement-tool.html 算好分頁**(別手算字數)。X 第二則若【機能調整】為空 → 標「不發」。
  - 🚫 **成品不要顯示字數(明羽 2026-06-04 交代)** —— 字數是內部拿來確認沒爆 280 的,**不要寫「253字」這種標註給明羽看**。則次/分頁標籤(如「𝕏 日文 第一則 (1/2)」)放 **code block 外**當小標即可;**code block 內只放可直接複製貼出的貼文本身**(含貼文內的 `(1/2)` 分頁標記)。
- 兩塊用清楚標題分隔。
...
### ⭐ 裁剪自動偵測:批次「半徑沒對準」失敗(2026-06-04 用 crop-dataset 確診,待修)

明羽匯出第一份裁剪紀錄資料集(`crop-dataset/`,74 筆;解壓在 `crop-dataset/extracted/`,已 gitignore)。用 `manifest.json` 的 `autos` vs `finals` 回放確診 badge-crop.html 批次偵測失敗共因:

- **單張自動偵測很穩**(平均誤差 3px、82% 幾乎完美),不用動。
- **批次兩個失敗模式**:
  - **🔴 A:預設半徑沒對準(主因、可修)** —— 例 id 58 徽章 r≈239 但自動在 r≈104 搜 → 抓到一堆小內部特徵(臉 / 局部)。半徑落差 >±30% 就崩(id 57–60、74);落差 ±20% 內全中。
  - **🟠 B:浮水印 + 全息雜訊(硬骨頭)** —— id 64–69 半徑其實對(r≈124),但滿版 SAMPLE 浮水印 + 全息底把徽章外緣票數蓋掉 → 幾乎抓不到。
- ⚠️ **「同心圓合併」假設已被資料推翻、作廢**,別再走那條。

**計畫(明羽已同意方向、待動工)**:給 `detectCirclesInImage` / `runBatchAutoDetect` 加**多尺度自動掃半徑**(自己試幾個半徑、挑共識最強的),修模式 A、也省去手設半徑。**改完務必拿 `crop-dataset/extracted/manifest.json` 回放驗證**:id 57–60/74 要變抓對,且 id 61/71/73 等本來就對的不能被改壞才定稿。模式 B 先擱置。
